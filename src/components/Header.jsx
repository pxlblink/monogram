export default function Header() {
  return (
    <div className="flex fixed right-0 left-0 z-10 justify-between p-2 pr-4 m-2 align-middle text-[#EFC2B3] bg-[#1A2456]">
      ...
      <div className="flex gap-8 items-center text-xs font-light tracking-[2px] font-prompt">
        <a href="" className="hidden lg:inline-block hover:text-[#ff8d6b]">
          HOW IT WORKS
        </a>
        <a
          href=""
          className="after:content-[''] hover:text-[#ff8d6b] after:border-l-[0.4em] after:border-l-transparent after:border-r-[0.4em] after:border-r-transparent after:border-t-[0.3em] after:border-b-0 items-center after:ml-1 hidden lg:flex"
        >
          WORKFLOWS
        </a>
        <a href="" className="hidden lg:inline-block hover:text-[#ff8d6b]">
        ...
        <a
          href=""
          className="hidden font-bold lg:inline-block hover:text-[#ff8d6b]"
        >
          SHOP
        </a>
        <div className="flex gap-3">
          ...
          <div className="flex gap-3 items-center">
            <svg height="25" width="25" fill="currentColor" viewBox="0 0 16 16">
              <path d="M8 1a2.5 2.5 0 0 1 2.5 2.5V4h-5v-.5A2.5 2.5 0 0 1 8 1zm3.5 3v-.5a3.5 3.5 0 1 0-7 0V4H1v10a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V4h-3.5zM2 5h12v9a1 1 0 0 1-1 1H3a1 1 0 0 1-1-1V5z"></path>
            </svg>
            <a
              href=""
              className="after:content-['']  hover:text-[#ff8d6b] after:border-l-[0.4em] after:border-l-transparent after:border-r-[0.4em] after:border-r-transparent after:border-t-[0.3em] after:border-b-0 flex items-center after:ml-1"
            >
              USD
            </a>
          </div>
